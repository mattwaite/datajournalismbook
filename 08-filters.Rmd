...
```{r}
prince_georges <- maryland %>% filter(project_county_name == "PRINCE GEORGES")
...
```{r}
large_prince_georges_nonprofit <- maryland %>% filter(project_county_name == "PRINCE GEORGES") %>% filter(business_type == "Non-Profit Organization") %>% filter(amount > 150000)
...
```{r}
and_prince_georges <- maryland %>% filter(project_county_name == "PRINCE GEORGES" & business_type == "Non-Profit Organization" & amount > 150000)
...
```{r}
or_prince_georges <- maryland %>% filter(project_county_name == "PRINCE GEORGES" | business_type == "Non-Profit Organization" | amount > 150000)
