...
In this class, we'll generally make use of unaggregated ["tidy data"](https://tidyr.tidyverse.org/articles/tidy-data.html#defining-tidy-data) that is organized into a grid of rows and columns in tables. 
