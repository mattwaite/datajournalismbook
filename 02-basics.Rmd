...
[R](https://www.r-project.org/about.html) is a programming language, one specifically geared toward statistical analysis. 
...
The real strength of any programming language is the external libraries (interchangably called "packages") that power it. The base language can do a lot, but it's the external libraries that solve many specific problems -- even making the base language easier to use. 
...
To install all of the Tidyverse libraries at once, the function is `install.packages('tidyverse)`.
