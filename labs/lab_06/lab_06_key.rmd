...
Q1. Which jurisdiction below the state level accounted for the largest percentage of international migration overall? For July 2011? You'll need to add and populate columns representing percent of total using `mutate`.
A1. Suburban Washington (62.8%)
