...
If you open `cleanclaims`, you'll notice something:

```{r}
cleanclaims %>% arrange(desc(filed_week_ended)) %>% head()
```

See it? The latest data isn't in there. [It's in a press release](https://www.dol.gov/sites/dolgov/files/OPA/newsreleases/ui-claims/20200510.pdf).
