...
>>>>>>> eed417f2e10235387b96218b235dfb785bf2ef0d
```{r}
ppp_maryland_loans <- read_rds("class_01_demonstration.rds")
```
...
```
How many companies got $10 million loans? One of them is a restaurant chain.  What kind of food do they server? Put your answers in the space below.
**Answer**
