...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nehospitals <-}\StringTok{ }\NormalTok{ne }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(TYPE }\OperatorTok{==}\StringTok{ "CRITICAL ACCESS"} \OperatorTok{|}\StringTok{ }\NormalTok{TYPE }\OperatorTok{==}\StringTok{ "GENERAL ACUTE CARE"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{geographic-queries}{%
\chapter{Geographic queries}\label{geographic-queries}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nebedcount <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(nehospitals }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(BEDS }\OperatorTok{!=}\StringTok{ }\DecValTok{-999}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(COUNTY, COUNTYFIPS) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{total_beds =} \KeywordTok{sum}\NormalTok{(BEDS)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{GEOID =}\NormalTok{ COUNTYFIPS)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{geometry)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nehospbycounty <-}\StringTok{ }\NormalTok{necounties }\OperatorTok{%>%}\StringTok{ }\KeywordTok{left_join}\NormalTok{(nebedcount)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_sf}\NormalTok{(}\DataTypeTok{data=}\NormalTok{nehospbycounty, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{fill=}\NormalTok{total_beds)) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_minimal}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{scale_fill_viridis_c}\NormalTok{(}\DataTypeTok{option =} \StringTok{"plasma"}\NormalTok{, }\DataTypeTok{trans =} \StringTok{"sqrt"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{datajournalism_files/figure-latex/unnamed-chunk-190-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nehospbycounty <-}\StringTok{ }\NormalTok{nehospbycounty }\OperatorTok{%>%}\StringTok{ }\KeywordTok{inner_join}\NormalTok{(nepop, }\DataTypeTok{by=}\StringTok{"GEOID"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{bedper1000 =}\NormalTok{ (total_beds}\OperatorTok{/}\NormalTok{estimate)}\OperatorTok{*}\DecValTok{1000}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_sf}\NormalTok{(}\DataTypeTok{data=}\NormalTok{nehospbycounty, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{fill=}\NormalTok{bedper1000)) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_minimal}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{scale_fill_viridis_c}\NormalTok{(}\DataTypeTok{option =} \StringTok{"plasma"}\NormalTok{, }\DataTypeTok{trans =} \StringTok{"sqrt"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{datajournalism_files/figure-latex/unnamed-chunk-196-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{as.data.frame}\NormalTok{(nehospbycounty }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(NAME.x, bedper1000) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(bedper1000)))}
\end{Highlighting}
\end{Shaded}
