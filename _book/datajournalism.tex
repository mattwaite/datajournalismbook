...
First, look at the two means on the bottom. On the left, it says the daily call average in the current group -- March 16 to March 31 -- is 295.73 calls per day. On the right, in previous March days, it's 297.86. So about 2.3 calls diffrence. Is that a sigificant difference? Look above to the p-value for that answer. At 0.7645, that's considerably higher than .05.
...
So what does this say? Typically, you'd see 48.85 disturbances a day on average before coronavirus. Now? 56. Is that a sigificant difference? According to our p-value of 0.0138, it is. So police are going to more disturbances than usual.
