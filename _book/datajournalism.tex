...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{change <-}\StringTok{ }\KeywordTok{round}\NormalTok{((((fedlatest}\OperatorTok{$}\NormalTok{initial_claims }\OperatorTok{-}\StringTok{ }\NormalTok{fedprevious}\OperatorTok{$}\NormalTok{initial_claims)}\OperatorTok{/}\NormalTok{fedprevious}\OperatorTok{$}\NormalTok{initial_claims)}\OperatorTok{*}\DecValTok{100}\NormalTok{), }\DataTypeTok{digits=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prechange <-}\StringTok{ }\KeywordTok{round}\NormalTok{((((fedlatest}\OperatorTok{$}\NormalTok{initial_claims }\OperatorTok{-}\StringTok{ }\NormalTok{pre}\OperatorTok{$}\NormalTok{initial_claims)}\OperatorTok{/}\NormalTok{pre}\OperatorTok{$}\NormalTok{initial_claims)}\OperatorTok{*}\DecValTok{100}\NormalTok{), }\DataTypeTok{digits=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
