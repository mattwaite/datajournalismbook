...
If you open \texttt{cleanclaims}, you may notice something:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{updatedcleanclaims <-}\StringTok{ }\NormalTok{cleanclaims }\OperatorTok{%>%}\StringTok{ }\KeywordTok{add_row}\NormalTok{(}\DataTypeTok{state=}\StringTok{"Nebraska"}\NormalTok{, }\DataTypeTok{filed_week_ended=}\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-28"}\NormalTok{), }\DataTypeTok{initial_claims=}\DecValTok{24572}\NormalTok{, }\DataTypeTok{reflecting_week_ended=}\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-21"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
The previous week \ldots{}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fedprevious <-}\StringTok{ }\NormalTok{fedranked }\OperatorTok{%>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pre <-}\StringTok{ }\NormalTok{fedranked }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(filed_week_ended}\OperatorTok{==}\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-14"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{change <-}\StringTok{ }\KeywordTok{round}\NormalTok{((((fedlatest}\OperatorTok{$}\NormalTok{initial_claims }\OperatorTok{-}\StringTok{ }\NormalTok{fedprevious}\OperatorTok{$}\NormalTok{initial_claims)}\OperatorTok{/}\NormalTok{fedprevious}\OperatorTok{$}\NormalTok{initial_claims)}\OperatorTok{*}\DecValTok{100}\NormalTok{), }\DataTypeTok{digits=}\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prechange <-}\StringTok{ }\KeywordTok{round}\NormalTok{((((fedlatest}\OperatorTok{$}\NormalTok{initial_claims }\OperatorTok{-}\StringTok{ }\NormalTok{pre}\OperatorTok{$}\NormalTok{initial_claims)}\OperatorTok{/}\NormalTok{pre}\OperatorTok{$}\NormalTok{initial_claims)}\OperatorTok{*}\DecValTok{100}\NormalTok{), }\DataTypeTok{digits=}\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{datajournalism_files/figure-latex/unnamed-chunk-238-1.pdf}
...
\includegraphics{datajournalism_files/figure-latex/unnamed-chunk-239-1.pdf}
...
\includegraphics{datajournalism_files/figure-latex/unnamed-chunk-245-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calls <-}\StringTok{ }\NormalTok{calls }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{RPT_Date =} \KeywordTok{ymd}\NormalTok{(RPT_Date))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calls }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(RPT_Date) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{total=}\KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{RPT_Date, }\DataTypeTok{y=}\NormalTok{total))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{datajournalism_files/figure-latex/unnamed-chunk-249-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calldays <-}\StringTok{ }\NormalTok{calls }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{month}\NormalTok{(RPT_Date) }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(RPT_Date) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{total_calls =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{TimePeriod =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{  RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Previous"}\NormalTok{,}
\NormalTok{  RPT_Date }\OperatorTok{>=}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Current"}\NormalTok{,}
\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-04-01"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calls }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(RPT_Date }\OperatorTok{>=}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-01"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tabyl}\NormalTok{(CFS_LEGEND)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{disturbance <-}\StringTok{ }\NormalTok{calls }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(CFS_LEGEND }\OperatorTok{==}\StringTok{ "DISTURBANCE"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{month}\NormalTok{(RPT_Date) }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(RPT_Date) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{total_calls =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{TimePeriod =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{  RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Previous"}\NormalTok{,}
\NormalTok{  RPT_Date }\OperatorTok{>=}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Current"}\NormalTok{,}
\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-04-01"}\NormalTok{))}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{traffic <-}\StringTok{ }\NormalTok{calls }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(CFS_LEGEND }\OperatorTok{==}\StringTok{ "TRAFFIC"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{month}\NormalTok{(RPT_Date) }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(RPT_Date) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{total_calls =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{TimePeriod =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{  RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Previous"}\NormalTok{,}
\NormalTok{  RPT_Date }\OperatorTok{>=}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Current"}\NormalTok{,}
\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-04-01"}\NormalTok{))}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{accident <-}\StringTok{ }\NormalTok{calls }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(CFS_LEGEND }\OperatorTok{==}\StringTok{ "ACCIDENT"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{month}\NormalTok{(RPT_Date) }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(RPT_Date) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{total_calls =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{TimePeriod =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{  RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Previous"}\NormalTok{,}
\NormalTok{  RPT_Date }\OperatorTok{>=}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Current"}\NormalTok{,}
\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-04-01"}\NormalTok{))}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calls }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{month}\NormalTok{(RPT_Date) }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(RPT_Date, CFS_LEGEND) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{total_calls =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{TimePeriod =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{  RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Previous"}\NormalTok{,}
\NormalTok{  RPT_Date }\OperatorTok{>=}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-16"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Current"}\NormalTok{,}
\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-04-01"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(TimePeriod, CFS_LEGEND) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{avg_calls =} \KeywordTok{mean}\NormalTok{(total_calls)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{pivot_wider}\NormalTok{(}\DataTypeTok{names_from =} \StringTok{"TimePeriod"}\NormalTok{, }\DataTypeTok{values_from =} \StringTok{"avg_calls"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{unl <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\StringTok{"data/unlcrime_covid.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{clean_names}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{reported =} \KeywordTok{mdy_hm}\NormalTok{(reported), }
    \DataTypeTok{start_occurred =} \KeywordTok{mdy_hm}\NormalTok{(start_occurred), }
    \DataTypeTok{end_occurred =} \KeywordTok{mdy_hm}\NormalTok{(end_occurred), }
    \DataTypeTok{case =} \KeywordTok{gsub}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{n"}\NormalTok{, }\StringTok{""}\NormalTok{, case)}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pre2020 <-}\StringTok{ }\NormalTok{unl }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(reported }\OperatorTok{<}\StringTok{ "2020-03-13"} \OperatorTok{&}\StringTok{ }\NormalTok{reported }\OperatorTok{>=}\StringTok{ "2020-01-01"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{post2020 <-}\StringTok{ }\NormalTok{unl }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(reported }\OperatorTok{>=}\StringTok{ "2020-03-13"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pre2020 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(incident_code) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tally}\NormalTok{(}\DataTypeTok{sort=}\OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{post2020 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(incident_code) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tally}\NormalTok{(}\DataTypeTok{sort=}\OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percent =}\NormalTok{ (n}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(n))}\OperatorTok{*}\DecValTok{100}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{top_n}\NormalTok{(}\DecValTok{10}\NormalTok{)}
...
\StringTok{  }\KeywordTok{tally}\NormalTok{(}\DataTypeTok{sort=}\OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percent =}\NormalTok{ (n}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(n))}\OperatorTok{*}\DecValTok{100}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(incident_code }\OperatorTok{==}\StringTok{ "TRESPASSING"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{pre2020 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest_tokens}\NormalTok{(word, summary) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{anti_join}\NormalTok{(stop_words) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(word) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tally}\NormalTok{(}\DataTypeTok{sort=}\OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percent =}\NormalTok{ (n}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(n))}\OperatorTok{*}\DecValTok{100}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{top_n}\NormalTok{(}\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{pre2020 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest_tokens}\NormalTok{(bigram, summary, }\DataTypeTok{token =} \StringTok{"ngrams"}\NormalTok{, }\DataTypeTok{n =} \DecValTok{2}\NormalTok{) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{bigram =} \KeywordTok{paste}\NormalTok{(word1, word2, }\DataTypeTok{sep=}\StringTok{" "}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(bigram) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tally}\NormalTok{(}\DataTypeTok{sort=}\OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percent =}\NormalTok{ (n}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(n))}\OperatorTok{*}\DecValTok{100}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{top_n}\NormalTok{(}\DecValTok{10}\NormalTok{)}
\end{Highlighting}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\NormalTok{word2 }\OperatorTok{%in%}\StringTok{ }\NormalTok{stop_words}\OperatorTok{$}\NormalTok{word) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{bigram =} \KeywordTok{paste}\NormalTok{(word1, word2, }\DataTypeTok{sep=}\StringTok{" "}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(bigram }\OperatorTok{==}\StringTok{ "student reported"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(incident_code) }\OperatorTok{%>%}
...
\href{https://source.opennews.org/articles/public-info-doesnt-always-want-be-free/}{This originally appeared on Open News in March 2013}.
...
So it turned out to be very important to know the Googlebot. It's your friend \ldots{} until it isn't. We went to our bosses and said words that no one had said to them before: we did not want Google to index these pages. In a news organization, the page view is the coin of the realm. It is --- unfortunately --- how many things are evaluated when the bosses ask if it was successful or not. So, with that in mind, Google is your friend. Google brings you traffic. Indeed, Google is your single largest referrer of traffic at a news organization, so you want to throw the doors open and make friends with the Googlebot.
