...
\NormalTok{  date <-}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{"selected"}\NormalTok{, }\StringTok{""}\NormalTok{, i)}
...
\begin{verbatim}
## Warning in if (checkdate < Sys.Date() & checkdate > as.Date("2020-01-13")) {:
