...
\item
  Then we're going to do some mutate magic. \texttt{case\_when} is if/else logic. So what this says is if the date is less than March 8, 2020, then it's in the Previous group. After and equal to March 8, 2020, it's in the Current group.
\item
...
\NormalTok{  RPT_Date }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-08"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Previous"}\NormalTok{,}
\NormalTok{  RPT_Date }\OperatorTok{>=}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2020-03-08"}\NormalTok{) }\OperatorTok{~}\StringTok{ "Current"}\NormalTok{,}
...
In R, a \texttt{t.test} is a base R function, owing to it being a statistical langauge. So were going to look at \texttt{total\_calls} split between \texttt{TimePeriod}s. Here's the code. We'll interpret the output below.
...
## t = -0.69299, df = 47.771, p-value = 0.4917
...
## 
## data:  total_calls by TimePeriod
## t = 2.8621, df = 37.162, p-value = 0.006875
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##   1.908816 11.158141
## sample estimates:
...
## 
## data:  total_calls by TimePeriod
## t = -5.351, df = 77.714, p-value = 8.572e-07
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -13.487462  -6.172538
## sample estimates:
...
## 
## data:  total_calls by TimePeriod
## t = -5.2963, df = 52.907, p-value = 2.33e-06
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -11.622648  -5.237352
## sample estimates:
...
##  4 ARSON           1        1.2 
##  5 ASSAULT         8.52    10.4 
##  6 BURGLARY        3.26     3.06
##  7 DISTURBANCE    55.0     48.5 
##  8 DRUGS           7.30    10.1 
##  9 DUI             1.83     3.03
## 10 EMBEZZLEMENT    1.14     1.43
## # ... with 26 more rows
\end{verbatim}
